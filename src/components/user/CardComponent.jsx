...
const CardComponent = ({ setAdd, add }) => {
  ...
  const addCardsArr = (e) =>{
    e.preventDefault()
    if(!cards.type) return errorMessage('Card typeis required')
...
console.log(data)
    ...
    return (
        <div className='w-full'>
            {add &&
                <>
                    <div className="w-full z-50 h-screen absolute flex top-5 items-center justify-center rounded-md bg-black/40 backdrop-blur-sm ">

                        <div ref={refdiv} className={`lg:w-3/4 w-11/12 relative mx-auto rounded-lg bg-white  py-6 px-5 `}>
                            ...
                            <div className="flex flex-col text-white h-full justify-between">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-start flex-col">
                                        ...
                                        <div className="font-bold text-2xl">{item.card_name}</div>
                                    </div>
